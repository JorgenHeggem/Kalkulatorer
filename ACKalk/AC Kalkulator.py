...
ctk.set_default_color_theme("blue")  # Themes: "green", "green", "dark-blue"
...
class KalkulatorApp:
    ...
    def finn_ikon_bane(self):
        ...
        if hasattr(sys, '_MEIPASS'):  # PyInstaller spesifikk temp-mappe
    ...
    def lag_gui(self):
        ...
        ctk.CTkLabel(venstre_ramme, text="Velg beregning:", font=("Arial", 14, "bold")).grid(row=0, column=0, padx=10, pady=10, sticky="w")
        self.beregningsvalg = ctk.CTkComboBox(venstre_ramme, values=["Ohms lov", "Seriekobling", "Parallellkobling", "VDR", "CDR", "Kap og Ind"], command=self.oppdater_beregning)
        self.beregningsvalg.grid(row=0, column=1, padx=10, pady=10, sticky="w")
        self.beregningsvalg.set("Ohms lov")

        # Valg for form (Polar eller Rektangulær)
        self.form_label = ctk.CTkLabel(venstre_ramme, text="Velg form:", font=("Arial", 14, "bold"))
        self.form_valg = ctk.CTkComboBox(venstre_ramme, values=["Polar", "Rektangulær"], command=self.oppdater_beregning)
        self.form_valg.grid(row=1, column=1, padx=10, pady=10, sticky="w")
        self.form_valg.set("Polar")
        self.form_label.grid(row=1, column=0, padx=10, pady=10, sticky="w")

        # Valg for komponent (Kondensator eller Spole) - starter skjult
        self.komponent_label = ctk.CTkLabel(venstre_ramme, text="Velg komponent:", font=("Arial", 14, "bold"))
        self.komponent_valg = ctk.CTkComboBox(venstre_ramme, values=["Kondensator", "Spole"], command=self.oppdater_beregning)
        self.komponent_valg.grid_forget()
        ...
        ctk.CTkLabel(hoyre_ramme, text="Notater:", font=("Arial", 14, "bold")).pack(pady=3)
    ...
    def formater_resultat(self, verdi):
        ...
        for faktor, enhet in enheter:
            if abs(verdi) < faktor * 1000:
                return f"{verdi / faktor:.2f}".replace('.', ',') + f" {enhet}"
    ...
    def beregn_ohms_lov_ac(self):
        ...
        try:
            ...
            self.resultat_label.configure(text=f"U = {self.formater_resultat(abs(U))} ∠ {math.degrees(cmath.phase(U)):.2f}° V\n"
    ...
    def oppdater_beregning(self, *args):
        ...
        if beregning == "Ohms lov":
            ...
            beregn_knapp = ctk.CTkButton(self.input_ramme, text="Beregn", command=self.beregn_ohms_lov_ac)
            ...
            if beregning == "Seriekobling":
                beregn_knapp = ctk.CTkButton(self.input_ramme, text="Beregn Seriekobling", command=self.beregn_seriekobling_ac)
            else:
                beregn_knapp = ctk.CTkButton(self.input_ramme, text="Beregn Parallellkobling", command=self.beregn_parallellkobling_ac)
            ...
            if form == "Polar":
                ctk.CTkLabel(self.input_ramme, text="Inngangsspenning magnitude (V):").grid(row=0, column=0, padx=10, pady=5, sticky="e")
                self.vin_input = ctk.CTkEntry(self.input_ramme)
                self.vin_input.grid(row=0, column=1, padx=10, pady=5)

                ctk.CTkLabel(self.input_ramme, text="Inngangsspenning fase (grader):").grid(row=1, column=0, padx=10, pady=5, sticky="e")
                ...
                ctk.CTkLabel(self.input_ramme, text="Inngangsspenning reell del (V):").grid(row=0, column=0, padx=10, pady=5, sticky="e")
                self.vin_input = ctk.CTkEntry(self.input_ramme)
                self.vin_input.grid(row=0, column=1, padx=10, pady=5)

                ctk.CTkLabel(self.input_ramme, text="Inngangsspenning imaginær del (V):").grid(row=1, column=0, padx=10, pady=5, sticky="e")
                self.p_input = ctk.CTkEntry(self.input_ramme)
                self.p_input.grid(row=1, column=1, padx=10, pady=5)
                ...
                ctk.CTkLabel(self.input_ramme, text="Impedans 3 reell del (Ω):").grid(row=6, column=0, padx=10, pady=5, sticky="e")
                self.r_input3 = ctk.CTkEntry(self.input_ramme)
                self.r_input3.grid(row=6, column=1, padx=10, pady=5)

                ctk.CTkLabel(self.input_ramme, text="Impedans 3 imaginær del (Ω):").grid(row=7, column=0, padx=10, pady=5, sticky="e")
                self.p_input3 = ctk.CTkEntry(self.input_ramme)
                self.p_input3.grid(row=7, column=1, padx=10, pady=5)

            beregn_knapp = ctk.CTkButton(self.input_ramme, text="Beregn VDR", command=self.beregn_vdr_ac)
            beregn_knapp.grid(row=8, column=0, columnspan=2, pady=20)
            ...
            beregn_knapp = ctk.CTkButton(self.input_ramme, text="Beregn CDR", command=self.beregn_cdr_ac)
            beregn_knapp.grid(row=6, column=0, columnspan=2, pady=20)
            ...
            if komponent == "Kondensator":
                ...
                beregn_knapp = ctk.CTkButton(self.input_ramme, text="Beregn Kondensator", command=self.beregn_kap_og_ind_ac)
                beregn_knapp.grid(row=6, column=0, columnspan=2, pady=20)
                ...
                self.f_input = ctk.CTkEntry(self.input_ramme)
                self.f_input.grid(row=1, column=1, padx=10, pady=5)
                beregn_knapp = ctk.CTkButton(self.input_ramme, text="Beregn Spole", command=self.beregn_kap_og_ind_ac)
                beregn_knapp.grid(row=6, column=0, columnspan=2, pady=20)
